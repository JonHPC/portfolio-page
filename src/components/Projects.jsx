          ...
          {projects.map((project) => (
            <a
              ...
              <div className="flex relative">
                <div className="px-8 py-10 relative z-0 w-full border-4 border-gray-200 dark:border-gray-700 bg-gray-300 dark:bg-gray-900 rounded opacity-100 transition ease-in-out hover:opacity-100">
                ...
                <img
                  alt="gallery"
                  className="absolute inset-0 w-full h-full object-cover object-center rounded  shadow-md z-1 opacity-0 hover:opacity-100"
                  src={project.image}
                />
              </div>
            </a>
